...
def run_equity_moe_training(
    *,
    artifact_dir: Path,
    min_market_cap: int = 10_000_000_000,
    data_start: str = "1900-01-01",
    data_end: str | None = None,
    train_end: str | None = None,
    top_k_values: Sequence[int] = (10, 20, 40),
    strategy_sources: Sequence[str] = DEFAULT_STRATEGY_SOURCES,
    ...
    config = MLTradingExperimentConfig(
        ...
        strategy_sources=tuple(strategy_sources),
...
def run_option_family_ranker_training(
    *,
    paths: TradingAppV2Paths,
    option_panel: Path,
