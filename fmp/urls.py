...
from .views import economic_indicators_form, macro_series_detail, symbol_chart, symbol_detail, treasury_rates_form, universe_screener, universe_screener_form
