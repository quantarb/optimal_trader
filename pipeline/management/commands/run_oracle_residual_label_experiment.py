...
class Command(BaseCommand):
    help = "Run the raw-vs-residual oracle label experiment."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--output-dirname", default="oracle_residual_experiment")
    ...
    def handle(self, *args, **options):
        ...
        payload = run_oracle_residual_label_experiment(
            ...
            output_dirname=str(options["output_dirname"]),
            resume_existing=bool(options["resume"]),
        )
        report_path = Path("docs") / "research" / "oracle_residual_label_experiment.md"
        write_oracle_residual_label_report(report_path=report_path, payload=payload)
